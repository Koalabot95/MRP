...
public sealed class Media : Atom, IAtom
{
    ...
    // Wird eine Session übergeben, kann der Benutzer anschließend diesen Media-Eintrag bearbeiten oder erstellen, sofern er berechtigt ist
    ...
    // Aktualisiert die Property-Werte. keine Berechtigungsprüfung da kein Endpoint darauf zugreifen kann 
    // _EndEdit() damit Bearbeitungsvorgang beendet wird und keine aktive Editing-Session fälschlicherweise bestehen bleibt.
