    ...
    public sealed class MediaHandler : Handler, IHandler
    {
        public override void Handle(HttpRestEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //Pfad parsen
                    string idStr = e.Path.Substring("/media/".Length);
                    ...
                    if (e.Method == HttpMethod.Put)
                    {
                        ...
                        //Admin/Owner Prüfung->MediaHandler
                        media.Save();
        ...
        // -----------------------------
        // Helper: Liest Token aus HTTP-Request, prüft ihn und gibt gültige Session zurück
        // -----------------------------
